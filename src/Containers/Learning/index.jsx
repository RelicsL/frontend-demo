...
export class Learning extends React.Component{
  ...
  render(){
    return (
      <Tabs className="learning-tabs">
        <Tabs.TabPane tab="校友学术" key="校友学术">
          <Layout className="learning-box">
            <Layout.Sider theme="light" className="learning-sider" width="420px">
              <Carousel autoplay>
                <div className="carouse-item">
                  <img src="http://www.ahszu.edu.cn/Article/UploadFiles/201904/2019040416445721.jpg"/>
                  <p>我校召开党委理论学习中心组学习会</p>
                </div>
                <div className="carouse-item">
                  <img src="http://www.ahszu.edu.cn/Article/UploadFiles/201904/2019040416182300.jpg"/>
                  <p>我校组织收看“安徽省劳动模范工匠大师进校园”直播活动</p>
                </div>
                <div className="carouse-item">
                  <img src="http://www.ahszu.edu.cn/Article/UploadFiles/201904/20190409124006408.jpg"/>
                  <p>外国语学院党总支召开总支委员扩大会议</p>
                </div>
                <div className="carouse-item">
                  <img src="http://www.ahszu.edu.cn/Article/UploadFiles/201904/2019040417521893.jpg"/>
                  <p>环测学院召开学生工作会议</p>
                </div>
              </Carousel>
            ...
            <Layout.Content className="learning-content">
              <List
